...
<div class="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-6">
    <h1 class="text-2xl font-bold mb-6 text-coffee">Profil Pengguna</h1>
    <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="username" value="{{ old('username', Auth::user()->username) }}" class="w-full border rounded px-3 py-2">
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <textarea name="address" rows="3" class="w-full border rounded px-3 py-2">{{ old('address', Auth::user()->address) }}</textarea>
        </div>
